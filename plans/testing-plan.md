...
> | 3. Тесты `src/lib/`        | ✅ Готово | 59     |
> | 4. Тесты `src/stores/`     | ✅ Готово | 162    |
...
> **Результат последнего прогона:** `Test Files 11 passed (11)`, `Tests 237 passed (237)`.
>
...
> - `src/stores/game.ts` — 95.19% statements / 86.72% branches (в т.ч. автопропуск хода, завершение партии, барьер + дубль).
