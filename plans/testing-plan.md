...
> ## 📌 Статус выполнения
>
> **Vitest настроен и работает.** Все юнит-тесты из разделов 3–5 написаны и **проходят (212 тестов / 10 файлов)**.
> Не реализован только **раздел 6 (интеграционные тесты)** — он остаётся актуальной задачей.
>
...
> | 6. Интеграционные тесты    | ⬜ Не начато | 0      |
> | 7. Настройка Vitest        | ✅ Готово    | —      |
>
> **Команды:** `npm run test` (run), `npm run test:watch`, `npm run test:coverage`.
> **Результат последнего прогона:** `Test Files 10 passed (10)`, `Tests 212 passed (212)`.
>
...
> - `.vue`-компоненты и раздел 6 (интеграционные тесты) пока не покрываются.
...
## 6. Интеграционные тесты (опционально) — ⬜ НЕ РЕАЛИЗОВАНО
...
> Обновлено по состоянию проекта: шаги 1–7 выполнены, остался шаг 8.
...
- [ ] **Интеграционные тесты** — полные сценарии игры (раздел 6)
