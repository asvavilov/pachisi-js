...
> ## 📌 Статус выполнения
>
> **Vitest настроен и работает.** Все юнит-тесты из разделов 3–5 написаны и **проходят**.
> Интеграционные тесты реализованы частично.
>
...
> | 6. Интеграционные тесты    | 🟡 Частично | 1/9    |
> | 7. Настройка Vitest        | ✅ Готово   | —      |
>
> **Команды:** `npm run test` (run), `npm run test:watch`, `npm run test:coverage`.
> **Результат последнего прогона:** `Test Files 11 passed (11)`, `Tests 222 passed (222)`.
>
...
| 5   | Выпал дубль → дополнительный бросок                                                           | ✅ Готово   |
...
- [ ] **Интеграционные тесты** — полные сценарии игры (раздел 6, 1/9 реализовано)
