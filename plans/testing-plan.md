...
> **Результат последнего прогона:** `Test Files 11 passed (11)`, `Tests 243 passed (243)`.
>
...
> | Lines      | 97.25% |
>
> - `src/lib/*` — 100% statements/branches/functions/lines.
> - `src/stores/game.ts` — 95.3% statements / 87.2% branches (в т.ч. автопропуск хода, завершение партии, барьер + дубль, `checkMove`/`consumeStep`).
